$(function () {
    ...
    $('#tableList').bootstrapTable('destroy').bootstrapTable({
        url: '/api/statistics/getStockFestivalStaticList' ,
        method: 'post',
    ...
    $("#backforthButton").click(function () {
        ...
        window.location.href = "/statistics/sectorFestivalStatisticsList?startTime=" + startTime + "&endTime=" + endTime + "&startDay=" + startDay + "&endDay=" + endDay;
