...
$(function () {
    ...
    $('#tableList').bootstrapTable('destroy').bootstrapTable({
        url: '/api/invest/getInvestForexOperateList',         //请求后台的URL（*）
        method: 'post',
    ...
    $("#submitDataButton").click(function () {
        ...
        var gainPoint = $("#gainPoint").val();
        $.APIPost("/api/invest/editInvestForexOperate",JSON.stringify({investStrategy :investStrategy , currencyPairs: currencyPairs, timeCycle: timeCycle ,investType :investType , startTime: startTime ,endTime:endTime ,lineNumber:lineNumber ,gainPoint:gainPoint }),function (data) {
            if(data.success){
                hideModal("myModal");
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            if (flashVersion) {
                (function(container) {
                    ...
                    var swf = '/libs/webuploader-0.1.5/expressInstall.swf';
                    // insert flash object
