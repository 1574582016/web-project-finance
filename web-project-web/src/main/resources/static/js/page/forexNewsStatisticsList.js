...
$(function () {
    ...
    $('#tableList').bootstrapTable('destroy').bootstrapTable({
        url: '/api/economy/getForexNewsStatisticsList',         //请求后台的URL（*）
        method: 'post',
    ...
    $("#submitDataButton").click(function () {
        ...
        $.APIPost("/api/economy/editForexNewsStatistics",JSON.stringify({id : id ,newsLevel :newsLevel , newsTopic: newsTopic, newsHot: newsHot ,keyWord :keyWord ,newsType:newsType}),function (data) {
            if(data.success){
                hideModal("myModal");
...
function edit(id) {
    $('#myModal').on('show.bs.modal',function() {
        $.APIPost("/api/economy/getForexNewsStatisticsById?id="+id ,function (data) {
            ...
            $("#newsType").val(data.data.result.newsType);
