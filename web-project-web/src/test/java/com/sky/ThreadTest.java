...
//                        marketCode = marketCode.substring(0,marketCode.length()-1);
    ...
    @Test
    public void test301() throws InterruptedException, ExecutionException {
    ...
    public void test3() throws InterruptedException, ExecutionException {
      ...
      for(int t = 1 ; t <=7 ;t++){
          ...
          List<IndexDealData> singleList = indexDealDataService.spiderIndexDealData(t , "1.000016" ,klt);
