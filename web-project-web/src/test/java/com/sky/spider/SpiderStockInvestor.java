...
/**
 * Created by ThinkPad on 2020/1/14.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class SpiderStockInvestor {
            ...
            task = new Callable<Integer>() {
                ...
                public Integer call() throws Exception {
                    for(StockCompanySector stockCode : listStr){
                        try{
                            stockInvestorProductService.spiderStockInvestorProduct(stockCode.getStockCode() ,stockCode.getStockName());
                            Thread.sleep(1000);
                        }catch (Exception e){
                            e.printStackTrace();
                        }
