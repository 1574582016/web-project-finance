...
public interface IndexDealDataService extends IService<IndexDealData> {
    ...
    List<StockIndexMonthData_VO> getStockSectorMonthDataList(String firstName,String sectorName,String startDay,String endDay ,String sectorMonth);
    ...
    List<StockIndexMonthData_VO> getStockDifferentSectorMonthList(List<String> indexList,String startDay,String endDay);
