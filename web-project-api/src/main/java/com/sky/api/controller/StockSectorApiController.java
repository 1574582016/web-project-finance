...
public class StockSectorApiController extends AbstractController {
    ...
    public Object getStockDifferentSectorMonthList(String indexNames ,String startDay ,String endDay){
        ...
        for(StockIndexMonthData_VO data_vo : voList){
            ...
            rateArr.add(data_vo.getOneRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getOneRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getTowRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getTowRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getThreeRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getThreeRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getFourRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getFourRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getFiveRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getFiveRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getSixRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getSixRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getSevenRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getSevenRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getEightRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getEightRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getNineRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getNineRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getTenRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getTenRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getElevenRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getElevenRiseRate() : BigDecimal.ZERO);
            rateArr.add(data_vo.getTwelveRiseRate().compareTo(BigDecimal.valueOf(60))>= 0 ? data_vo.getTwelveRiseRate() : BigDecimal.ZERO);
